...
export class MockDataService {
  ...
  getMockData(): I_DisplayableData[] {
    return [test_displayed_data, test_displayed_data2, test_displayed_data3, test_displayed_data4, test_displayed_data5, test_displayed_data6, test_displayed_data7, test_displayed_data8];
  }
