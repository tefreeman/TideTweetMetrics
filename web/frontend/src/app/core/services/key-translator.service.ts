...
export class KeyTranslatorService {
  ...
  private _translationObject: I_KeyTranslator = {
    ...
    "tweet_likes": { full: "Like counts", abr: "TLike", desc: "Number of Likes on a given Tweet", order: 2 },
    "tweet_retweets": { full: "Retweet counts", abr: "TRet", desc: "Number of Retweets of a given Tweet", order: 2 },
    "tweet_replies": { full: "Reply counts", abr: "TRep", desc: "Number of Replies on a given Tweet", order: 2 },
    "tweet_quotes": { full: "Quote counts", abr: "TQuote", desc: "Number of Quotes in a given Tweet", order: 2 },
    "tweet_hashtags": { full: "Hashtag counts", abr: "THash", desc: "Number of Hashtags in a given Tweet", order: 2 },
    "tweet_cashtags": { full: "Cashtag counts", abr: "TCash", desc: "Number of Cashtags in a given Tweet", order: 2 },
    "tweet_mentions": { full: "Mention counts", abr: "TMent", desc: "Number of Mentions in a given Tweet", order: 2 },
    "tweet_urls": { full: "URL counts", abr: "TUrl", desc: "Number of URLs in a given Tweet", order: 2 },
    "tweet_photos": { full: "Photo counts", abr: "TPhoto", desc: "Number of Photos in a given Tweet", order: 2 },
    "tweet_videos": { full: "Video counts", abr: "TVid", desc: "Number of Videos in a given Tweet", order: 2 },
    "tweet_cards": { full: "Card counts", abr: "TCard", desc: "Number of Cards in a given Tweet", order: 2 },
    ...
    "tweet_chars": { full: "Character counts", abr: "TChar", desc: "Number of characters in a given Tweet", order: 2 },
    "tweet_words": { full: "Word counts", abr: "TWord", desc: "Number of words in a given Tweet", order: 2 },
    "tweet_annotations": { full: "Annotation counts", abr: "TAnn", desc: "Number of annotations in a given Tweet", order: 2 },
