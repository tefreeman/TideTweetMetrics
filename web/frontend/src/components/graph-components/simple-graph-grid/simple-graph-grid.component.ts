...
import { I_BarGraphCard } from '../../../core/interfaces/displayable-data-interface';
...
export class SimpleGraphGridComponent implements OnInit, OnDestroy {
   ...
   */
  @Output() cardClicked: EventEmitter<I_BarGraphCard> = new EventEmitter();
   ...
   */
  @Input({ required: true }) dataArr: I_BarGraphCard[] = [];
   ...
   */
  onCardClick(card: I_BarGraphCard): void {
