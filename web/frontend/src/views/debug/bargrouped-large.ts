...
function getData() {
    const data = [
      { year: "@alabama_cs", likes: 20, follows: 20, retweets: 10, shares: 15, comments: 5 },
      { year: "@auburnidk", likes: 34, follows: 10, retweets: 4, shares: 22, comments: 9 },
      { year: "@otherschool", likes: 46, follows: 30, retweets: 20, shares: 35, comments: 15 },
      { year: "@otherschool1", likes: 8, follows: 26, retweets: 10, shares: 10, comments: 3 },
    ];
